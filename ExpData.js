...
ExpData.prototype.staticTranslations = {
    ...
    Spanish: {
        ...
        submit: "Envíe",
        confirm: "Confirmar",
        initialSurvey: "Complete los campos a continuación (los campos obligatorios están marcados con *):",
        yourGender: "Género",
        yourGenderMale: "Masculina",
        ...
        errorGender: "Falta de género",
        errorAge: "Falta de edad",
        errorCountry: "Falta de país",
        errorLanguage: "Falta de idioma",
        errorEmail: "Falta de correo electrónico",
        errorSessionNotReady: "Actualmente no puede participar en este experimento porque este estudio solo puede iniciarse en ciertos momentos.",
        errorSessionStartIn: "Puedes comenzar esta sesión en",
        refresh: "Actualizar",
        errorSessionOver: "Actualmente no puede participar en este experimento porque no hay una ventana de tiempo de inicio definida para este estudio.",
        loading1: "Experimento de carga...",
        loading2: "Cargando, por favor espere",
        loading3: "Esto podría tomar un tiempo.",
        ...
        playerErrorNoBlock: "Error: no hay bloque definido en esta sesión de experimento.",
        ...
        calibrateMethod2: "Utilice una tarjeta de identificación estandarizada (85.60 × 53.98 mm) o cualquier otra tarjeta del mismo tamaño contra la pantalla e intente hacer coincidir el tamaño de la tarjeta que se muestra. " +
            "Puede cambiar el tamaño de la imagen arrastrando la flecha. La calibración es correcta si la imagen coincide exactamente con el tamaño de la tarjeta.",
        endExpMsg: "¡Gracias! La sesión de experimento ha finalizado.",
        ...
        waitingForOtherParticipants: "Esperando más participantes...",
        experimentStartsShortly: "Su experimento comenzará en breve....",
        successfullyMatched_1: "Con éxito emparejado. prensa ",
        successfullyMatched_2: " para proceder a experimentar!",
        continueJointExpLobby: "Seguir",
        jointExpTestConnection: "Probar su conexión a internet. por favor espere 30 segundos...",
        yourCrowdsourcingID: "Su identificación de trabajadora / crowdsourcing ID (*):",
        AdLibraryEndOfStudy: "Participa en experimentos de comportamiento más emocionantes:",
        AdRegisterEndOfStudy: "O regístrese y cree su propio estudio gratis:",
        inviteFriendMultiUser1: "¿Necesitas otro jugador? Invita a un amigo!",
        inviteFriendMultiUser2: "Tu nombre:",
        inviteFriendMultiUser3: "El correo electrónico de tus amigos:",
        inviteFriendMultiUser4: "Invitar",
        ...
        askEmailConsent2: "Este es un estudio longitudinal, que consta de varias sesiones de participación. Su correo electrónico solo será recodificado para invitarlo / recordarle que participe en la próxima sesión. Su correo electrónico no se almacenará junto con otros tipos de datos, y solo es accesible internamente a la plataforma Labvanced. No regalaremos " +
